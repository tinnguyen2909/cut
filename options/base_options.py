...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--enable_rotation', action='store_true', help='Enable rotation on B images', default=False)
        parser.add_argument('--rotation_probability', type=int, help='Probability of rotation', default=20)
